			...
			<ImageBackground
				...
				<SafeAreaView className='p-4 relative h-screen z-10'>
					<View className='pt-[100px]'>
						<Text className='text-4xl text-center font-pbold text-white'>
							Serenify
						</Text>
					...
					<Image
						source={MeditationPose}
						resizeMode='contain'
						className='mt-[100px] w-[300px] h-[300px] mx-auto'
					/>
					<View className='mt-[50px]'>
						<CustomButton
							title='Get Started'
							onPress={() => router.push("./meditate-category")}
						/>
					</View>
				</SafeAreaView>
			</ImageBackground>
